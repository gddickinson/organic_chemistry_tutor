...
| `content/` | Markdown lessons organised by level (`beginner/`, `intermediate/`, `advanced/`, `graduate/`). **215 lessons total as of round 211 (2026-04-26)** — beginner 68, intermediate 51, advanced 46, graduate 50. The curriculum spans foundational concepts (atoms, bonds, IUPAC, stereochemistry, NMR/IR/MS reading, lab safety, glassware) → core mechanism families (SN/E, EAS, carbonyl, aldol, pericyclic, organometallics, radicals) → modern catalysis + synthesis (asym organocatalysis, Pd/Ni/Cu/Au cross-coupling, C-H activation, metathesis, photoredox, bioorthogonal, macrocycles, SPPS, DEL, asym hydrogenation, FLPs, SACs, mechanochemistry, sustainable polymers) → cutting-edge research (cryo-EM, ssNMR, hyperpolarised NMR, EPR, XPS, VCD, comp catalyst design, ML retrosynthesis + protein design, NN potentials, generative chemistry, CSP, MD, FEP, molecular electronics, OLEDs, batteries, hydrogen, carbon capture). Tutorial-coverage audit (`tests/test_tutorial_coverage.py`) pins glossary 100 % / catalogue-molecule ≥ 85 % / named-reaction ≥ 45 % / fully-integrated ≥ 40 %. |
