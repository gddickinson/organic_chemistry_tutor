"""Phase PH-1.0 (round 214) — Pharm Studio tutorial panel."""
...
class PharmTutorialPanel(QWidget):
    """Tree of pharm lessons + markdown reader."""
    ...
    def _build_ui(self) -> None:
        ...
        outer.addWidget(QLabel(
            "<b>Pharmacology Studio — tutorials.</b>  "
            "Phase PH-1.0 ships one starter lesson; the full "
            "Pharm curriculum is planned for Phase PH-4."))
