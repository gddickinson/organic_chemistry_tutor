"""Phase BT-1.0 (round 216) — Botany Studio tutorial panel."""
...
class BotanyTutorialPanel(QWidget):
    """Tree of botany lessons + markdown reader."""
    ...
    def _build_ui(self) -> None:
        ...
        outer.addWidget(QLabel(
            "<b>Botany Studio — tutorials.</b>  "
            "Phase BT-1.0 ships one starter lesson; the full "
            "Botany curriculum is planned for Phase BT-4."))
