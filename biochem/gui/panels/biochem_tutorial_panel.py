"""Phase BC-1.0 (round 213) — Biochem Studio tutorial panel.

Reads ``biochem.tutorial.curriculum.CURRICULUM`` + renders
markdown lessons.  Same minimal pattern as cellbio's tutorial
panel.
"""
...
class BiochemTutorialPanel(QWidget):
    """Tree of biochem lessons + markdown reader."""
    ...
    def _build_ui(self) -> None:
        ...
        outer.addWidget(QLabel(
            "<b>Biochem Studio — tutorials.</b>  Phase BC-1.0 "
            "ships one starter lesson; the full Biochem "
            "curriculum is planned for Phase BC-4."))
