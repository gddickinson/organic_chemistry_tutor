"""Phase AB-1.0 (round 217) — Animal Biology Studio tutorial
panel."""
...
class AnimalTutorialPanel(QWidget):
    """Tree of animal lessons + markdown reader."""
    ...
    def _build_ui(self) -> None:
        ...
        outer.addWidget(QLabel(
            "<b>Animal Biology Studio — tutorials.</b>  "
            "Phase AB-1.0 ships a Welcome lesson + a "
            "**platform retrospective** documenting the "
            "full 6-studio build chain.  The deeper "
            "Animal-Biology curriculum is planned for "
            "Phase AB-4."))
